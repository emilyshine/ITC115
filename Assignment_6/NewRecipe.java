 ...
 * Emily A. Shine
 * February 18th, 2015
 * Assignment 6 - NewRecipe.java
 * This is a display class for a swing form that will 
 * allow user to create a new recipe and enter 
 * the associated recipe data.  It also provides a 
 * display area showing the the data entered by the 
 * user.
 * ***************************************************** */
